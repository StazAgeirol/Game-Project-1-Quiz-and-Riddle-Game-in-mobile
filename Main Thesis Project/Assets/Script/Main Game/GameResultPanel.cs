...
public class GameResultPanel : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        TextScore_1.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleScore_1;
        TextScore_2.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleScore_2;
        TextScore_3.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleScore_3;
        TextScore_4.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleScore_4;
        TextScore_5.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleScore_5;
        TextScore_6.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleScore_6;
        TextScore_7.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleScore_7;
        TextScore_8.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleScore_8;
        TextScore_9.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleScore_9;

        TextTime_1.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleTime_1;
        TextTime_2.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleTime_2;
        TextTime_3.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleTime_3;
        TextTime_4.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleTime_4;
        TextTime_5.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleTime_5;
        TextTime_6.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleTime_6;
        TextTime_7.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleTime_7;
        TextTime_8.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleTime_8;
        TextTime_9.text = playersaveSystem.GetComponent<PlayerSaveSystem>().RiddleTime_9;
